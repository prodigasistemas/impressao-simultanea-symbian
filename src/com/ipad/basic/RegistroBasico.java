...
public class RegistroBasico extends Registro implements Persistable {
    ...
    public RegistroBasico(String linhaArquivo) {
	...
	this.setDescricao(parser.obterDadoParser(90));

	this.setValor(parser.obterDadoParser(14));
	this.setCodigo(parser.obterDadoParser(6));
	this.setIndcUso( (short) Constantes.SIM );
    }
	...
	return
		obj instanceof RegistroBasico &&
		( ( RegistroBasico ) obj ).getCodigo().equals( this.getCodigo() );
    }

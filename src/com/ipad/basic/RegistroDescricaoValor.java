...
public class RegistroDescricaoValor extends Registro implements Persistable{
	...
	public RegistroDescricaoValor(){
		super();
	}    
    
    public RegistroDescricaoValor( String linhaArquivo ) {

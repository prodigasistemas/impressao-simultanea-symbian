...
/**
 * Dados das Contas em Débito
 */
public class ImovelReg7 extends Registro implements Persistable {
    ...
    public ImovelReg7( String linhaArquivo ) {
        ...
        this.setAnoMes( parser.obterDadoParser( 6 ) );
        this.setValor( parser.obterDadoParser( 14 ) );
        this.setDataVencimento( parser.obterDadoParser( 8 ) );
        this.setValorAcrescimosImpontualidade( parser.obterDadoParser( 8 ) );
    }

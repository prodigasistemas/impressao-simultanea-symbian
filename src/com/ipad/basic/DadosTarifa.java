...
public class DadosTarifa implements Persistable {
    ...
    public DadosTarifa( ImovelReg9 imovelReg9 ) {
        
        this.inicioVigencia = imovelReg9.getDataVigenciaReg9();
        this.codigoCategoria = imovelReg9.getCodigoCategoriaReg9();
        this.codigoSubcategoria = imovelReg9.getCodigoSubcategoriaReg9();
        this.consumoMinimo = imovelReg9.getConsumoMinimoSubcategoriaReg9();
        this.tarifaMinima = imovelReg9.getTarifaMinimaCategoriaReg9();
